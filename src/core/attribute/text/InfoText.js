default export class InfoText extends StringAttributeAtom {
	...
	@Override
	public AbstractAttributeAtom<InfoText, String> createAttributeAtomControl(
			Browser browser,
			Selection sectionBody,
			FocusChangingRefreshable treeViewerRefreshable) {

		Selection card = sectionBody.append("div");

		Selection cardTitle = card.append("label") //
				.style("padding-bottom", "5px");
		cardTitle.text(label);

		Selection cardContent = card.append("div") //
				//.style("height", "50px")
				.style("overflow-y", "auto");

		String html = get().replace("\n", "<br>");
