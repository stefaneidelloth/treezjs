default export class TextField extends StringAttributeAtom {
	...
	@Override
	public AbstractAttributeAtom<TextField, String> createAttributeAtomControl(
			Browser browser,
		...
		div.append("style") //
				.text("input:focus {"//
						+ "   border-bottom: 5px green green !important;"//
						+ "   box-shadow: 0 1px 0 0 green !important"//
						+ "}"

		);

		Selection labelSelection = div.append("label") //
				.attr("for", name);
		labelSelection.text(label);

		Selection input = div.append("input") //
				.attr("type", "text")
				.style("height", "1.5rem")
