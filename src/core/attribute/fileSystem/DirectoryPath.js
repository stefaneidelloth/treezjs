default export class DirectoryPath extends StringAttributeAtom {
	 ...
	 */
	private GridComposite checkBoxAndLabelContainer;
	...
	@Override
	public AbstractAttributeAtom<DirectoryPath, String> createAttributeAtomControl(
			Browser browser,
