default export class FilePath extends AbstractStringAttributeAtom {
	...
	private GridComposite container;

	private GridComposite horizontalContainer;
	...
	public AbstractStringAttributeAtom<FilePath> createAttributeAtomControl(
		...
		container = createVerticalContainer(parent);

		horizontalContainer = createHorizontalContainer(container);

		//label
		labelComposite = toolkit.createLabel(horizontalContainer, label);
	...
	@Override
	public AbstractAttributeAtom<FilePath, String> createAttributeAtomControl(
			Browser browser,
	...
	private void createSubContainer() {
		subContainer = new GridComposite(container);
	...
	public FilePath setBackgroundColor(Color backgroundColor) {
		...
		if (isAvailable(horizontalContainer)) {
			horizontalContainer.setBackground(backgroundColor);
		}
